 ...
 */
final class Version20210403195450 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8DCBA8874F FOREIGN KEY (shop_rel_id) REFERENCES shop (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
